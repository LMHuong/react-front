...
class EditProfile extends Component {
    ...
    isValid = () => {
        ...
        if (fileSize > 100000) { //accept pic < than 100Kb
            this.setState({ error: "Photo size is too big, please choose photo", loading: false });
            return false;
        }
        if (name.length === 0) {
            this.setState({ error: "Username can't be empty!", loading: false });
            return false;
        }
